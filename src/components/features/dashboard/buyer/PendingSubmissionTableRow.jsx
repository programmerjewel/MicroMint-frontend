    ...
    <TableRow className="hover:bg-slate-50/50 transition-colors">
      ...
      <TableCell className="font-semibold text-green-700">
        <div className="flex items-center justify-center gap-2">
          ...
          <span>{submission.payable_amount.toFixed(2)}</span>
        </div>
      </TableCell>
          ...
          <DialogContent className="sm:max-w-106.25">
            ...
            <div className="grid gap-4 py-4">
              <div className="space-y-2">
                <h4 className="text-sm font-bold text-slate-900">Worker Proof Info:</h4>
                <div className="p-4 bg-slate-50 rounded-md border text-sm text-slate-600 leading-relaxed italic">
            ...
            <DialogFooter className="flex flex-row gap-2 sm:justify-end">
              ...
              <ConfirmActionModal
                ...
                trigger={
                  <Button size="sm" className="bg-emerald-600 hover:bg-emerald-700 flex-1 sm:flex-none text-white">

...
const RoleCard = ({ icon: Icon, role, description, features, iconBg }) => {
  const IconComponent = Icon;
  (
  <Card className="group relative overflow-hidden border-2 border-slate-100 hover:border-brand-primary transition-all duration-300 shadow-none">
    <CardHeader>
      ...
      <CardTitle className="text-xl font-bold text-slate-900">{role}</CardTitle>
    </CardHeader>
    <CardContent>
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold uppercase text-slate-900 mb-8 tracking-tight">
            Work Small. <br />
            <span className="text-brand-primary">Earn Big.</span>
          </h1>
          <p className="text-md text-slate-600 max-w-2xl mx-auto mb-12 leading-relaxed">
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="text-center space-y-4">
            ...
            <p className="text-slate-500 text-sm">Tasks are approved and paid out in record time through our streamlined review system.</p>
          </div>
          <div className="text-center space-y-4">
            ...
            <h3 className="text-xl font-bold text-slate-900">Verified Security</h3>
            <p className="text-slate-500 text-sm">Our 2-step verification process ensures that both buyers and workers are protected.</p>
          </div>
          <div className="text-center space-y-4">
            ...
            <h3 className="text-xl font-bold text-slate-900">Global Opportunity</h3>
            <p className="text-slate-500 text-sm">Access a borderless economy with tasks tailored to your region and expertise.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div className="max-w-xl text-left">
              <h2 className="text-4xl font-black text-slate-900 mb-4 uppercase tracking-tighter">The Ecosystem</h2>
              <p className="text-slate-500 font-medium">Three pillars, one unified platform. Whether you're here to work or grow, we've built a space for you.</p>
            </div>
            <div className="h-1 grow mx-10 bg-slate-200 mb-4 hidden md:block rounded-full" />
          </div>
      ...
      <section className="py-20 text-center">
        <h2 className="text-3xl font-bold text-slate-900 mb-8 italic tracking-tight">Ready to join the minting revolution?</h2>
        <Button className="group bg-slate-900 text-white rounded-full px-8 py-6 h-auto text-lg font-bold hover:bg-slate-800 transition-all">
